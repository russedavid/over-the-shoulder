...
The [OCR source-mapping fix](docs/ocr-source-mapping.md) addresses that line-number mismatch. Fresh runs of both failing screenshots now populate the observed workspace and produce correctly numbered diffs. Mapped source preserves indentation and remains subject to exact region, filename and line-origin checks.
